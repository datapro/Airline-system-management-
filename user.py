...
img=Label(user,image=simg, bg="#5e546e" , width=300, height=100 )
img.image=simg
img.place(x=0, y=0)
lbl=Label(user, text="User Area", font=("sanseri",50,"bold"), bg="#5e546e", fg="#fff", underline=6)
lbl.place(x=400, y=0)

lbl2=Label(user,text="Passenger's Name:", font=("sanserif",12), bg="#5e546e", fg="white")
lbl2.place(x=300, y=100)
ent1=Entry(user, width=50)
ent1.place(x=450,y=100)

lblage=Label(user,text="Age:", font=("sanserif",12), bg="#5e546e", fg="white")
lblage.place(x=300, y=130)
entage=Entry(user, width=20)
entage.place(x=450,y=130)

lblgender=Label(user,text="Gender:", font=("sanserif",12), bg="#5e546e", fg="white")
lblgender.place(x=300, y=160)
entgender=Entry(user, width=20)
entgender.place(x=450,y=160)

lblpassport=Label(user,text="Passport Number", font=("sanserif",12), bg="#5e546e", fg="white")
lblpassport.place(x=300, y=190)
entpassport=Entry(user, width=50)
entpassport.place(x=450,y=190)

lblcontact=Label(user,text="Contact Info:", font=("sanserif",12), bg="#5e546e", fg="white")
lblcontact.place(x=300, y=220)
entcontact=Entry(user, width=50)
entcontact.place(x=450,y=220)

lblflightid=Label(user,text="flight Id:", font=("sanserif",12), bg="#5e546e", fg="white")
lblflightid.place(x=300, y=250)
entflightid=Entry(user, width=50)
entflightid.place(x=450,y=250)

lblpassengerID=Label(user,text="Passenger Id:", font=("sanserif",12), bg="#5e546e", fg="white")
...
btnbook=Button(user,text="Book Flight", font=("sanserif",12,"bold"), bg="black", fg="white", width=10, command=submit_booking)
